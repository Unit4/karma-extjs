# [karma](http://karma-runner.github.io/)-extjs [![Build Status](https://travis-ci.org/bjornhol/karma-extjs.svg?branch=master)](https://travis-ci.org/bjornhol/karma-extjs) [![NPM Version](http://img.shields.io/npm/v/karma-extjs.svg)](https://www.npmjs.org/package/karma-extjs) [![NPM Dependencies](https://david-dm.org/bjornhol/karma-extjs.svg)](https://www.npmjs.org/package/karma-extjs) 
